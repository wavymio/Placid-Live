        ...
        <div className={` w-full flex flex-col sm:flex-row items-center justify-center gap-5 sm:gap-5 md:gap-16 xs:px-0 sm:px-10`}>
            {sameUser ? (
                <div className='relative z-10'>
                    <img src={user?.profilePicture ? user.profilePicture : `https://cdn.pfps.gg/pfps/9815-no-icon-black.png`} alt="img" className='object-cover h-28 w-28 xs:h-32 xs:w-32 sm:h-32 sm:w-32 md:h-44 md:w-44 rounded-full' />
                    {isProfilePicLoading ? (
