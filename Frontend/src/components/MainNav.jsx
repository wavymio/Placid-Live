    ...
    return (
        <div className='relative inline-block'>
            <div className='flex items-center gap-2'>
                ...
                <img onClick={handlePfpClick} src={user?.profilePicture ? user?.profilePicture : 'https://cdn.pfps.gg/pfps/9815-no-icon-black.png'} className='object-cover h-10 w-10 rounded-full border-2 border-gray-200 cursor-pointer transition-transform transform hover:scale-105' />
            </div>
